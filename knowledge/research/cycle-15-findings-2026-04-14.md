# Anvil Cycle Report — invoice-pulse — Cycle 15
**Date:** 2026-04-14

## Executive Summary
- **Total files:** 4636
- **Total chunks:** 3836
- **High risk chunks:** 860
- **Average composite score:** 0.2636
- **Total findings:** 1959
...
| web/contracts.py | contracts_list | function | 0.864 | 1.00 | 0.98 |
...
| web/contracts.py | contract_lanes_bulk | function | 0.821 | 1.00 | 0.98 |
| web/action_queue.py | record_response | function | 0.809 | 1.00 | 0.83 |
...
| web/contract_import.py | _validate_contract_json | function | 0.789 | 1.00 | 0.73 |
| web/carrier_profiles.py | _build_carrier_cards | function | 0.788 | 1.00 | 0.93 |
| web/contracts.py | contract_fuel_brackets_bulk | function | 0.780 | 1.00 | 0.98 |
...
| app.py | run_validation | function | 0.774 | 1.00 | 1.00 |
...
| app.py | invoices_list | function | 0.770 | 1.00 | 1.00 |
| web/contracts.py | contract_new | function | 0.765 | 1.00 | 0.98 |
| web/contracts.py | contract_fak_bulk | function | 0.765 | 1.00 | 0.98 |
| app.py | debug_export | function | 0.762 | 1.00 | 1.00 |
...
|---|---|---|---|---|---|
| contract_tables.py | create_contract_tables | 0.992 | 3845 | 33912 | 0.744 |
| database.py | _create_tables | 0.975 | 4214 | 18777 | 0.738 |
| contract_tables.py | extend_existing_tables | 0.961 | 3845 | 10849 | 0.775 |
| engines/triangulation.py | triangulate | 0.958 | 12466 | 1694 | 0.482 |
| database.py | init_db | 0.952 | 8997 | 4168 | 0.575 |
| ingestion/ingest.py | _to_float | 0.949 | 12796 | 0 | 0.643 |
| engines/validator.py | validate_invoice | 0.946 | 6540 | 6126 | 0.620 |
| app.py | _table_exists | 0.938 | 11688 | 75 | 0.559 |
| engines/validator.py | add | 0.929 | 10462 | 0 | 0.462 |
| ingestion/activity_import.py | import_activity_history | 0.924 | 6622 | 2851 | 0.833 |
| engines/validator.py | gate_9_accessorials | 0.918 | 6160 | 2926 | 0.446 |
| contract_tables.py | _safe_add_column | 0.915 | 8622 | 154 | 0.722 |
| web/contracts.py | _build_dashboard_cards | 0.907 | 3719 | 4349 | 0.641 |
| engines/validator.py | gate_8_fuel | 0.904 | 5082 | 2809 | 0.549 |
| engines/validator.py | gate_7_linehaul | 0.901 | 4614 | 3108 | 0.549 |
| engines/exit_interview.py | run_pro_exit_interviews | 0.895 | 6776 | 616 | 0.354 |
| engines/action_router.py | route_actions | 0.893 | 5003 | 2156 | 0.751 |
| ingestion/ingest.py | _insert_charge | 0.887 | 6930 | 154 | 0.616 |
| web/carrier_profiles.py | _float_or_none | 0.878 | 6739 | 0 | 0.646 |
| extraction_tracking.py | write_extraction_quality_report | 0.876 | 4004 | 2156 | 0.806 |
| web/utils.py | normalize_zip | 0.873 | 6018 | 0 | 0.610 |
| ingestion/ingest.py | enrich_invoice_xml | 0.870 | 5390 | 616 | 0.619 |
| ingestion/xml_parser.py | parse | 0.864 | 5675 | 0 | 0.493 |
| extraction_tracking.py | record_extraction_result | 0.859 | 5390 | 154 | 0.554 |
| web/data_hygiene.py | data_hygiene_page | 0.859 | 0 | 5544 | 0.524 |
| web/utils.py | flash_safe_error | 0.856 | 5453 | 0 | 0.594 |
| web/contract_import.py | _import_contract | 0.853 | 154 | 5236 | 0.712 |
| backup.py | main | 0.850 | 4619 | 770 | 0.316 |
| system_logger.py | log_event | 0.848 | 4958 | 308 | 0.586 |
| engines/confidence.py | record_evidence | 0.845 | 4620 | 616 | 0.533 |
...
|---|---|---|---|
| eia_fetcher.py | get_eia_price_for_date | 1.000 | 0.499 |
...
| engines/email_matcher.py | match_pros_to_invoices | 1.000 | 0.575 |
| engines/training.py | _build_discrepancy | 1.000 | 0.455 |
| engines/variance_analyzer.py | _adjust_confidence_by_history | 1.000 | 0.466 |
| extraction_tracking.py | compute_prompt_version | 1.000 | 0.612 |
| extraction_tracking.py | _compute_fields_multi_section | 1.000 | 0.707 |
| ingestion/csv_reader.py | _map_rows | 1.000 | 0.469 |
| ingestion/csv_reader.py | _read_excel | 1.000 | 0.470 |
...
| tests/test_base_rates_file_upload.py | test_csv_file_upload_auto_links_contract | 1.000 | 0.253 |
...
- **[high]** `contract_tables.py::create_contract_tables` — Coupling score 0.99, 3845 inbound + 33912 outbound deps
- **[high]** `database.py::_create_tables` — Coupling score 0.97, 4214 inbound + 18777 outbound deps
- **[high]** `contract_tables.py::extend_existing_tables` — Coupling score 0.96, 3845 inbound + 10849 outbound deps
- **[high]** `engines/triangulation.py::triangulate` — Coupling score 0.96, 12466 inbound + 1694 outbound deps
- **[high]** `database.py::init_db` — Coupling score 0.95, 8997 inbound + 4168 outbound deps
- **[high]** `ingestion/ingest.py::_to_float` — Coupling score 0.95, 12796 inbound + 0 outbound deps
- **[high]** `engines/validator.py::validate_invoice` — Coupling score 0.95, 6540 inbound + 6126 outbound deps
- **[high]** `app.py::_table_exists` — Coupling score 0.94, 11688 inbound + 75 outbound deps
- **[high]** `engines/validator.py::add` — Coupling score 0.93, 10462 inbound + 0 outbound deps
- **[high]** `ingestion/activity_import.py::import_activity_history` — Coupling score 0.92, 6622 inbound + 2851 outbound deps
- **[high]** `engines/validator.py::gate_9_accessorials` — Coupling score 0.92, 6160 inbound + 2926 outbound deps
- **[high]** `contract_tables.py::_safe_add_column` — Coupling score 0.92, 8622 inbound + 154 outbound deps
- **[high]** `web/contracts.py::_build_dashboard_cards` — Coupling score 0.91, 3719 inbound + 4349 outbound deps
- **[high]** `engines/validator.py::gate_8_fuel` — Coupling score 0.90, 5082 inbound + 2809 outbound deps
- **[high]** `engines/validator.py::gate_7_linehaul` — Coupling score 0.90, 4614 inbound + 3108 outbound deps
...
- Methods: 68
- Test cases: 1975
- Dependencies: 1892284
- Similarity pairs: 7789
- Average health score: 0.2636
- High risk count: 860
