# Anvil Cycle Report — invoice-pulse — Cycle 17
**Date:** 2026-05-17

## Executive Summary
- **Total files:** 4958
- **Total chunks:** 3956
- **High risk chunks:** 932
- **Average composite score:** 0.2595
- **Total findings:** 1944

## Coverage Gaps (14 findings)
| File | Name | Type | Composite | Coverage | Volatility |
|---|---|---|---|---|---|
| web/action_queue.py | action_queue | function | 0.850 | 1.00 | 1.00 |
| web/action_queue.py | record_response | function | 0.800 | 1.00 | 1.00 |
| web/contracts.py | contracts_list | function | 0.800 | 1.00 | 0.56 |
| web/contracts.py | contract_fuel_import_combined | function | 0.794 | 1.00 | 0.56 |
| web/contracts.py | contract_lanes_bulk | function | 0.754 | 1.00 | 0.56 |
| web/contracts.py | contract_edit | function | 0.728 | 1.00 | 0.56 |
| web/contracts.py | contract_new | function | 0.716 | 1.00 | 0.56 |
| ingestion/activity_import.py | import_activity_history | function | 0.713 | 1.00 | 0.00 |
| profile_ingestion.py | run_profiled_ingestion | function | 0.712 | 1.00 | 0.00 |
| engines/lane_matcher.py | match_lane | function | 0.711 | 1.00 | 0.22 |
| web/contracts.py | contract_fuel_brackets_bulk | function | 0.710 | 1.00 | 0.56 |
| web/contracts.py | contract_fak_bulk | function | 0.707 | 1.00 | 0.56 |
| web/carrier_profiles.py | carrier_import_accessorials | function | 0.706 | 1.00 | 0.00 |
| web/contracts.py | contract_merge | function | 0.706 | 1.00 | 0.56 |

## Coupling Hotspots (47 findings)
| File | Name | Coupling | Inbound | Outbound | Composite |
|---|---|---|---|---|---|
| contract_tables.py | create_contract_tables | 0.992 | 4543 | 42134 | 0.560 |
| database.py | _create_tables | 0.976 | 4964 | 23319 | 0.501 |
| contract_tables.py | extend_existing_tables | 0.962 | 4543 | 13587 | 0.591 |
| engines/triangulation.py | triangulate | 0.957 | 15429 | 2101 | 0.476 |
| database.py | init_db | 0.954 | 11153 | 5289 | 0.288 |
| engines/validator.py | validate_invoice | 0.952 | 8391 | 7603 | 0.529 |
| ingestion/ingest.py | _to_float | 0.949 | 15899 | 0 | 0.467 |
| app.py | _table_exists | 0.941 | 14432 | 85 | 0.382 |
| engines/validator.py | add | 0.933 | 13040 | 0 | 0.407 |
| ingestion/activity_import.py | import_activity_history | 0.927 | 8213 | 3544 | 0.713 |
| engines/validator.py | gate_9_accessorials | 0.922 | 7640 | 3629 | 0.391 |
| contract_tables.py | _safe_add_column | 0.916 | 10750 | 191 | 0.539 |
| web/contracts.py | _build_dashboard_cards | 0.911 | 4857 | 5404 | 0.558 |
| engines/validator.py | gate_8_fuel | 0.908 | 6303 | 3497 | 0.494 |
| engines/validator.py | gate_7_linehaul | 0.906 | 5765 | 3895 | 0.494 |
| engines/exit_interview.py | run_pro_exit_interviews | 0.900 | 8404 | 764 | 0.292 |
| engines/action_router.py | route_actions | 0.895 | 6197 | 2674 | 0.597 |
| ingestion/ingest.py | _insert_charge | 0.892 | 8595 | 191 | 0.441 |
| web/carrier_profiles.py | _float_or_none | 0.884 | 8353 | 0 | 0.460 |
| extraction_tracking.py | write_extraction_quality_report | 0.881 | 4966 | 2674 | 0.626 |
| ingestion/ingest.py | enrich_invoice_xml | 0.879 | 6685 | 764 | 0.444 |
| web/utils.py | normalize_zip | 0.876 | 7383 | 0 | 0.460 |
| ingestion/xml_parser.py | parse | 0.873 | 7040 | 0 | 0.426 |
| extraction_tracking.py | record_extraction_result | 0.868 | 6685 | 191 | 0.375 |
| web/data_hygiene.py | data_hygiene_page | 0.868 | 0 | 6876 | 0.452 |
| backup.py | main | 0.865 | 5759 | 955 | 0.336 |
| web/utils.py | flash_safe_error | 0.863 | 6706 | 0 | 0.445 |
| web/contract_import.py | _import_contract | 0.860 | 191 | 6494 | 0.567 |
| engines/confidence.py | record_evidence | 0.857 | 5730 | 764 | 0.447 |
| engines/email_matcher.py | extract_pro_numbers | 0.857 | 5539 | 955 | 0.447 |
...
|---|---|---|---|
| eia_fetcher.py | get_eia_price_for_date | 1.000 | 0.388 |
| engines/action_router.py | _build_dispute_email | 1.000 | 0.490 |
| engines/action_router.py | _build_pricing_ticket | 1.000 | 0.496 |
| engines/action_router.py | _build_summary | 1.000 | 0.568 |
| engines/email_matcher.py | match_pros_to_invoices | 1.000 | 0.577 |
| engines/training.py | _build_discrepancy | 1.000 | 0.421 |
| engines/variance_analyzer.py | _adjust_confidence_by_history | 1.000 | 0.460 |
| extraction_tracking.py | compute_prompt_version | 1.000 | 0.439 |
| extraction_tracking.py | _compute_fields_multi_section | 1.000 | 0.530 |
...
| tests/test_coverage_batch1.py | test_reshape_for_apply_standard | 1.000 | 0.208 |
| tests/test_coverage_batch1.py | test_reshape_for_apply_empty | 1.000 | 0.175 |
| tests/test_coverage_batch1.py | test_parse_charge_csv_valid | 1.000 | 0.185 |
...
| tests/test_csv_parsers.py | test_unknown_section_type_returns_error | 1.000 | 0.174 |
| tests/test_eia_padd_regions.py | test_env | 1.000 | 0.175 |
| tests/test_email_archiver_scope.py | test_resolved_with_dispute_appears | 1.000 | 0.192 |
| tests/test_email_archiver_scope.py | test_resolved_without_dispute_excluded | 1.000 | 0.190 |
...
|---|---|---|---|
| PROJECT_STATUS.md | knowledge/research/agent-prompt-feedback.md | 146 | 0.325 |
...
## Planner Constraints (191 total)

### coverage_required (14)
...
- **[high]** `web/contracts.py::contracts_list` — Composite score 0.80, no test coverage, volatility 0.56
- **[high]** `web/contracts.py::contract_fuel_import_combined` — Composite score 0.79, no test coverage, volatility 0.56
- **[high]** `web/contracts.py::contract_lanes_bulk` — Composite score 0.75, no test coverage, volatility 0.56
- **[high]** `web/contracts.py::contract_edit` — Composite score 0.73, no test coverage, volatility 0.56
- **[high]** `web/contracts.py::contract_new` — Composite score 0.72, no test coverage, volatility 0.56
- **[high]** `ingestion/activity_import.py::import_activity_history` — Composite score 0.71, no test coverage, volatility 0.00
- **[high]** `profile_ingestion.py::run_profiled_ingestion` — Composite score 0.71, no test coverage, volatility 0.00
- **[high]** `engines/lane_matcher.py::match_lane` — Composite score 0.71, no test coverage, volatility 0.22
- **[high]** `web/contracts.py::contract_fuel_brackets_bulk` — Composite score 0.71, no test coverage, volatility 0.56
- **[high]** `web/contracts.py::contract_fak_bulk` — Composite score 0.71, no test coverage, volatility 0.56
- **[high]** `web/carrier_profiles.py::carrier_import_accessorials` — Composite score 0.71, no test coverage, volatility 0.00
- **[high]** `web/contracts.py::contract_merge` — Composite score 0.71, no test coverage, volatility 0.56

### verify_dependents (47)
- **[high]** `contract_tables.py::create_contract_tables` — Coupling score 0.99, 4543 inbound + 42134 outbound deps
- **[high]** `database.py::_create_tables` — Coupling score 0.98, 4964 inbound + 23319 outbound deps
- **[high]** `contract_tables.py::extend_existing_tables` — Coupling score 0.96, 4543 inbound + 13587 outbound deps
- **[high]** `engines/triangulation.py::triangulate` — Coupling score 0.96, 15429 inbound + 2101 outbound deps
- **[high]** `database.py::init_db` — Coupling score 0.95, 11153 inbound + 5289 outbound deps
- **[high]** `engines/validator.py::validate_invoice` — Coupling score 0.95, 8391 inbound + 7603 outbound deps
- **[high]** `ingestion/ingest.py::_to_float` — Coupling score 0.95, 15899 inbound + 0 outbound deps
- **[high]** `app.py::_table_exists` — Coupling score 0.94, 14432 inbound + 85 outbound deps
- **[high]** `engines/validator.py::add` — Coupling score 0.93, 13040 inbound + 0 outbound deps
- **[high]** `ingestion/activity_import.py::import_activity_history` — Coupling score 0.93, 8213 inbound + 3544 outbound deps
- **[high]** `engines/validator.py::gate_9_accessorials` — Coupling score 0.92, 7640 inbound + 3629 outbound deps
- **[high]** `contract_tables.py::_safe_add_column` — Coupling score 0.92, 10750 inbound + 191 outbound deps
- **[high]** `web/contracts.py::_build_dashboard_cards` — Coupling score 0.91, 4857 inbound + 5404 outbound deps
- **[high]** `engines/validator.py::gate_8_fuel` — Coupling score 0.91, 6303 inbound + 3497 outbound deps
- **[high]** `engines/validator.py::gate_7_linehaul` — Coupling score 0.91, 5765 inbound + 3895 outbound deps
...
- Methods: 68
- Test cases: 2056
- Dependencies: 2357743
- Similarity pairs: 8779
- Average health score: 0.2595
- High risk count: 932
