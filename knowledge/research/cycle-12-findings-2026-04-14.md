# Anvil Cycle Report — invoice-pulse — Cycle 12
**Date:** 2026-04-14

## Executive Summary
- **Total files:** 4635
- **Total chunks:** 3836
- **High risk chunks:** 680
- **Average composite score:** 0.2630
- **Total findings:** 2063

## Coverage Gaps (56 findings)
| File | Name | Type | Composite | Coverage | Volatility |
|---|---|---|---|---|---|
| web/carrier_profiles.py | carrier_import_accessorials | function | 0.871 | 1.00 | 0.93 |
| web/carrier_profiles.py | carrier_import_fuel | function | 0.864 | 1.00 | 0.93 |
| web/contracts.py | contract_fuel_import_combined | function | 0.860 | 1.00 | 0.98 |
...
| web/contracts.py | contract_lanes_bulk | function | 0.817 | 1.00 | 0.98 |
| web/action_queue.py | record_response | function | 0.812 | 1.00 | 0.83 |
| web/rates.py | rates_grid | function | 0.806 | 1.00 | 0.89 |
| extraction_tracking.py | write_extraction_quality_report | function | 0.804 | 1.00 | 0.90 |
| app.py | dispute_brief | function | 0.804 | 1.00 | 1.00 |
| app.py | team_dashboard | function | 0.799 | 1.00 | 1.00 |
| app.py | invoice_detail | function | 0.790 | 1.00 | 1.00 |
| ingestion/ingest.py | _run_ingestion_rows | function | 0.789 | 1.00 | 0.88 |
| web/contracts.py | contract_edit | function | 0.787 | 1.00 | 0.98 |
| web/carrier_profiles.py | _build_carrier_cards | function | 0.784 | 1.00 | 0.93 |
| web/contract_import.py | _validate_contract_json | function | 0.783 | 1.00 | 0.73 |
| web/contracts.py | contract_fuel_brackets_bulk | function | 0.776 | 1.00 | 0.98 |
| contract_tables.py | extend_existing_tables | function | 0.773 | 1.00 | 0.94 |
| web/carrier_profiles.py | carrier_profile_detail | function | 0.773 | 1.00 | 0.93 |
| app.py | run_validation | function | 0.770 | 1.00 | 1.00 |
| web/email_triage.py | email_archiver | function | 0.769 | 1.00 | 0.86 |
| app.py | ingest_xml_paste | function | 0.766 | 1.00 | 1.00 |
| app.py | invoices_list | function | 0.766 | 1.00 | 1.00 |
| web/contracts.py | _save_contract | function | 0.766 | 1.00 | 0.98 |
| app.py | debug_export | function | 0.765 | 1.00 | 1.00 |
| web/contracts.py | contract_new | function | 0.761 | 1.00 | 0.98 |
| web/contracts.py | contract_fak_bulk | function | 0.761 | 1.00 | 0.98 |
| validate_batch.py | run_batch | function | 0.758 | 1.00 | 0.86 |

## Coupling Hotspots (77 findings)
| File | Name | Coupling | Inbound | Outbound | Composite |
|---|---|---|---|---|---|
| profile_ingestion.py | execute | 1.000 | 450084 | 0 | 0.222 |
| profile_ingestion.py | commit | 0.997 | 99850 | 0 | 0.213 |
| profile_ingestion.py | close | 0.994 | 46083 | 0 | 0.209 |
| contract_tables.py | create_contract_tables | 0.991 | 2873 | 23268 | 0.744 |
| tests/test_lifecycle.py | test_main | 0.988 | 0 | 22666 | 0.443 |
| tests/test_validator.py | test_main | 0.985 | 0 | 20712 | 0.569 |
| web/action_queue.py | _get_db | 0.982 | 18966 | 106 | 0.731 |
| tests/test_carrier_profiles.py | get_db | 0.979 | 18744 | 106 | 0.391 |
| database.py | get_connection | 0.976 | 17595 | 318 | 0.576 |
| database.py | _create_tables | 0.973 | 3164 | 12894 | 0.737 |
| tests/conftest.py | _insert_invoice | 0.970 | 13903 | 29 | 0.424 |
| tests/test_forms_and_uploads.py | test_main | 0.967 | 0 | 13218 | 0.516 |
| tests/test_activity_import.py | _seed_invoice | 0.964 | 10684 | 212 | 0.470 |
| tests/test_upload_endpoints.py | test_main | 0.961 | 0 | 10812 | 0.434 |
| contract_tables.py | extend_existing_tables | 0.958 | 2873 | 7342 | 0.773 |
| engines/triangulation.py | triangulate | 0.955 | 8614 | 1166 | 0.486 |
| database.py | init_db | 0.952 | 6198 | 2749 | 0.574 |
| ingestion/ingest.py | _to_float | 0.949 | 8779 | 0 | 0.642 |
| tests/test_confidence.py | test_main | 0.946 | 0 | 8586 | 0.471 |
| tests/test_training.py | test_main | 0.946 | 0 | 8586 | 0.478 |
| tests/test_integration.py | test_main | 0.943 | 0 | 8480 | 0.471 |
| engines/validator.py | validate_invoice | 0.940 | 4236 | 4212 | 0.619 |
| app.py | _table_exists | 0.937 | 8112 | 60 | 0.559 |
| tests/test_captured_verified_counts.py | _seed_contract | 0.933 | 7686 | 318 | 0.371 |
| tests/test_navisphere_attestation_qa.py | _setup_full_scenario | 0.930 | 5300 | 2650 | 0.364 |
| tests/test_conf_integration.py | test_main | 0.927 | 0 | 7738 | 0.470 |
| engines/validator.py | add | 0.924 | 7135 | 0 | 0.461 |
| tests/test_contracts.py | test_main | 0.921 | 0 | 7102 | 0.491 |
| ingestion/activity_import.py | import_activity_history | 0.918 | 4558 | 1954 | 0.834 |
| tests/test_carrier_profiles.py | test_main | 0.915 | 0 | 6360 | 0.414 |
...
| engines/action_router.py | _build_pricing_ticket | 1.000 | 0.651 |
...
| engines/variance_analyzer.py | _adjust_confidence_by_history | 1.000 | 0.462 |
| extraction_tracking.py | compute_prompt_version | 1.000 | 0.599 |
| extraction_tracking.py | _compute_fields_multi_section | 1.000 | 0.702 |
...
| tests/test_base_rates_file_upload.py | test_csv_file_upload_auto_links_contract | 1.000 | 0.249 |
...
| tests/test_csv_parsers.py | test_unknown_section_type_returns_error | 1.000 | 0.217 |
...
## Planner Constraints (265 total)

### coverage_required (56)
...
### verify_dependents (77)
- **[high]** `profile_ingestion.py::execute` — Coupling score 1.00, 450084 inbound + 0 outbound deps
- **[high]** `profile_ingestion.py::commit` — Coupling score 1.00, 99850 inbound + 0 outbound deps
- **[high]** `profile_ingestion.py::close` — Coupling score 0.99, 46083 inbound + 0 outbound deps
- **[high]** `contract_tables.py::create_contract_tables` — Coupling score 0.99, 2873 inbound + 23268 outbound deps
- **[medium]** `tests/test_lifecycle.py::test_main` — Coupling score 0.99, 0 inbound + 22666 outbound deps
- **[medium]** `tests/test_validator.py::test_main` — Coupling score 0.98, 0 inbound + 20712 outbound deps
- **[high]** `web/action_queue.py::_get_db` — Coupling score 0.98, 18966 inbound + 106 outbound deps
- **[high]** `tests/test_carrier_profiles.py::get_db` — Coupling score 0.98, 18744 inbound + 106 outbound deps
- **[high]** `database.py::get_connection` — Coupling score 0.98, 17595 inbound + 318 outbound deps
- **[high]** `database.py::_create_tables` — Coupling score 0.97, 3164 inbound + 12894 outbound deps
- **[high]** `tests/conftest.py::_insert_invoice` — Coupling score 0.97, 13903 inbound + 29 outbound deps
- **[medium]** `tests/test_forms_and_uploads.py::test_main` — Coupling score 0.97, 0 inbound + 13218 outbound deps
- **[high]** `tests/test_activity_import.py::_seed_invoice` — Coupling score 0.96, 10684 inbound + 212 outbound deps
- **[medium]** `tests/test_upload_endpoints.py::test_main` — Coupling score 0.96, 0 inbound + 10812 outbound deps
- **[high]** `contract_tables.py::extend_existing_tables` — Coupling score 0.96, 2873 inbound + 7342 outbound deps
...
- Methods: 68
- Test cases: 1975
- Dependencies: 1293340
- Similarity pairs: 6319
- Average health score: 0.2630
- High risk count: 680
