# Anvil Cycle Report — invoice-pulse — Cycle 10
**Date:** 2026-04-14

## Executive Summary
- **Total files:** 4635
- **Total chunks:** 3836
- **High risk chunks:** 567
- **Average composite score:** 0.2625
- **Total findings:** 2066

## Coverage Gaps (57 findings)
| File | Name | Type | Composite | Coverage | Volatility |
|---|---|---|---|---|---|
| web/carrier_profiles.py | carrier_import_accessorials | function | 0.873 | 1.00 | 0.93 |
...
| ingestion/activity_import.py | import_activity_history | function | 0.836 | 1.00 | 0.62 |
| web/action_queue.py | record_response | function | 0.820 | 1.00 | 0.83 |
| web/contracts.py | contract_lanes_bulk | function | 0.819 | 1.00 | 0.98 |
| web/rates.py | rates_grid | function | 0.812 | 1.00 | 0.89 |
...
| app.py | invoice_detail | function | 0.790 | 1.00 | 1.00 |
| ingestion/ingest.py | _run_ingestion_rows | function | 0.790 | 1.00 | 0.88 |
| web/contracts.py | contract_edit | function | 0.788 | 1.00 | 0.98 |
| web/carrier_profiles.py | _build_carrier_cards | function | 0.786 | 1.00 | 0.93 |
...
| web/carrier_profiles.py | carrier_profile_detail | function | 0.775 | 1.00 | 0.93 |
| contract_tables.py | extend_existing_tables | function | 0.774 | 1.00 | 0.94 |
| app.py | run_validation | function | 0.773 | 1.00 | 1.00 |
| web/email_triage.py | email_archiver | function | 0.771 | 1.00 | 0.85 |
...
## Coupling Hotspots (79 findings)
| File | Name | Coupling | Inbound | Outbound | Composite |
|---|---|---|---|---|---|
| profile_ingestion.py | execute | 1.000 | 333714 | 0 | 0.222 |
| profile_ingestion.py | commit | 0.997 | 74371 | 0 | 0.213 |
| profile_ingestion.py | close | 0.994 | 34194 | 0 | 0.209 |
| contract_tables.py | create_contract_tables | 0.991 | 2275 | 17297 | 0.743 |
| tests/test_lifecycle.py | test_main | 0.988 | 0 | 16919 | 0.444 |
| tests/test_validator.py | test_main | 0.986 | 0 | 15441 | 0.568 |
| web/action_queue.py | _get_db | 0.983 | 14225 | 79 | 0.731 |
| tests/test_carrier_profiles.py | get_db | 0.980 | 13996 | 79 | 0.391 |
| database.py | get_connection | 0.977 | 13076 | 237 | 0.576 |
| database.py | _create_tables | 0.974 | 2514 | 9592 | 0.737 |
| tests/test_forms_and_uploads.py | test_main | 0.971 | 0 | 9867 | 0.518 |
| tests/conftest.py | _insert_invoice | 0.968 | 9266 | 16 | 0.424 |
| tests/test_upload_endpoints.py | test_main | 0.965 | 0 | 8058 | 0.436 |
| contract_tables.py | extend_existing_tables | 0.962 | 2275 | 5404 | 0.774 |
| tests/test_activity_import.py | _seed_invoice | 0.959 | 7480 | 158 | 0.475 |
| engines/triangulation.py | triangulate | 0.957 | 6441 | 869 | 0.487 |
| database.py | init_db | 0.954 | 4622 | 1978 | 0.575 |
| ingestion/ingest.py | _to_float | 0.951 | 6526 | 0 | 0.642 |
| tests/test_confidence.py | test_main | 0.948 | 0 | 6399 | 0.471 |
| tests/test_training.py | test_main | 0.948 | 0 | 6399 | 0.479 |
| tests/test_integration.py | test_main | 0.945 | 0 | 6320 | 0.472 |
| engines/validator.py | validate_invoice | 0.942 | 3015 | 3136 | 0.619 |
| app.py | _table_exists | 0.939 | 6088 | 50 | 0.559 |
| tests/test_navisphere_attestation_qa.py | _setup_full_scenario | 0.936 | 3950 | 1975 | 0.364 |
| tests/test_accessorial_aliases.py | _insert_invoice | 0.933 | 5788 | 79 | 0.407 |
| tests/test_conf_integration.py | test_main | 0.930 | 0 | 5767 | 0.472 |
| tests/test_captured_verified_counts.py | _seed_contract | 0.927 | 5157 | 237 | 0.370 |
| tests/test_contracts.py | test_main | 0.925 | 0 | 5293 | 0.493 |
| engines/validator.py | add | 0.922 | 5277 | 0 | 0.460 |
| ingestion/activity_import.py | import_activity_history | 0.919 | 3397 | 1451 | 0.836 |
...
|---|---|---|---|
| eia_fetcher.py | get_eia_price_for_date | 1.000 | 0.506 |
| engines/action_router.py | _build_dispute_email | 1.000 | 0.648 |
| engines/action_router.py | _build_pricing_ticket | 1.000 | 0.654 |
| engines/action_router.py | _build_summary | 1.000 | 0.725 |
...
| extraction_tracking.py | compute_prompt_version | 1.000 | 0.595 |
| extraction_tracking.py | _compute_fields_multi_section | 1.000 | 0.700 |
| ingestion/csv_reader.py | _map_rows | 1.000 | 0.474 |
| ingestion/csv_reader.py | _read_excel | 1.000 | 0.475 |
| tests/conftest.py | app_client | 1.000 | 0.450 |
| tests/test_base_rates_file_upload.py | test_blank_csv_download_returns_correct_headers | 1.000 | 0.257 |
| tests/test_base_rates_file_upload.py | test_csv_file_upload_auto_links_contract | 1.000 | 0.248 |
| tests/test_base_rates_file_upload.py | test_csv_file_upload_rejects_mismatch | 1.000 | 0.246 |
| tests/test_base_rates_file_upload.py | test_csv_upload_rejects_invalid_extension | 1.000 | 0.246 |
| tests/test_base_rates_file_upload.py | test_csv_upload_with_missing_columns | 1.000 | 0.246 |
| tests/test_contract_display_label.py | test_label_none_contract | 1.000 | 0.192 |
| tests/test_contract_rates_paste.py | test_invoice_detail_rates_url_targets_import_section | 1.000 | 0.340 |
| tests/test_coverage_batch1.py | test_reshape_for_apply_standard | 1.000 | 0.252 |
| tests/test_coverage_batch1.py | test_reshape_for_apply_empty | 1.000 | 0.219 |
| tests/test_coverage_batch1.py | test_parse_charge_csv_valid | 1.000 | 0.228 |
| tests/test_coverage_batch1.py | test_parse_charge_csv_none_safety | 1.000 | 0.219 |
| tests/test_csv_parsers.py | test_contract_setup_happy_path | 1.000 | 0.226 |
| tests/test_csv_parsers.py | test_lanes_combined_format | 1.000 | 0.223 |
| tests/test_csv_parsers.py | test_fuel_float_parsing | 1.000 | 0.223 |
| tests/test_csv_parsers.py | test_empty_csv_returns_error | 1.000 | 0.220 |
| tests/test_csv_parsers.py | test_unknown_section_type_returns_error | 1.000 | 0.218 |
| tests/test_eia_padd_regions.py | test_env | 1.000 | 0.200 |
| tests/test_email_archiver_scope.py | test_resolved_with_dispute_appears | 1.000 | 0.201 |
...
| LOW | coupling_hotspot | test_main (tests/test_lifecycle.py) — high-coupling node (coupling_score=0.99) | Architecture check |
| MEDIUM | coupling_hotspot | test_main (tests/test_validator.py) — high-coupling node (coupling_score=0.99) | Architecture check |
...
| MEDIUM | complexity_hotspot | test_main (tests/test_disputes.py) — high cyclomatic complexity (complexity_scor | Fix |
| MEDIUM | complexity_hotspot | test_main (tests/test_forms_and_uploads.py) — high cyclomatic complexity (comple | Fix |
| LOW | complexity_hotspot | test_main (tests/test_lifecycle.py) — high cyclomatic complexity (complexity_sco | Fix |
| LOW | complexity_hotspot | test_main (tests/test_upload_endpoints.py) — high cyclomatic complexity (complex | Fix |
...
- **[high]** `ingestion/activity_import.py::import_activity_history` — Composite score 0.84, no test coverage, volatility 0.62
...
### verify_dependents (79)
- **[high]** `profile_ingestion.py::execute` — Coupling score 1.00, 333714 inbound + 0 outbound deps
- **[high]** `profile_ingestion.py::commit` — Coupling score 1.00, 74371 inbound + 0 outbound deps
- **[high]** `profile_ingestion.py::close` — Coupling score 0.99, 34194 inbound + 0 outbound deps
- **[high]** `contract_tables.py::create_contract_tables` — Coupling score 0.99, 2275 inbound + 17297 outbound deps
- **[medium]** `tests/test_lifecycle.py::test_main` — Coupling score 0.99, 0 inbound + 16919 outbound deps
- **[medium]** `tests/test_validator.py::test_main` — Coupling score 0.99, 0 inbound + 15441 outbound deps
- **[high]** `web/action_queue.py::_get_db` — Coupling score 0.98, 14225 inbound + 79 outbound deps
- **[high]** `tests/test_carrier_profiles.py::get_db` — Coupling score 0.98, 13996 inbound + 79 outbound deps
- **[high]** `database.py::get_connection` — Coupling score 0.98, 13076 inbound + 237 outbound deps
- **[high]** `database.py::_create_tables` — Coupling score 0.97, 2514 inbound + 9592 outbound deps
- **[medium]** `tests/test_forms_and_uploads.py::test_main` — Coupling score 0.97, 0 inbound + 9867 outbound deps
- **[high]** `tests/conftest.py::_insert_invoice` — Coupling score 0.97, 9266 inbound + 16 outbound deps
- **[medium]** `tests/test_upload_endpoints.py::test_main` — Coupling score 0.97, 0 inbound + 8058 outbound deps
- **[high]** `contract_tables.py::extend_existing_tables` — Coupling score 0.96, 2275 inbound + 5404 outbound deps
- **[high]** `tests/test_activity_import.py::_seed_invoice` — Coupling score 0.96, 7480 inbound + 158 outbound deps
...
- Test cases: 1975
- Dependencies: 959884
- Similarity pairs: 5339
- Average health score: 0.2625
- High risk count: 567
